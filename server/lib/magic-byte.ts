...
export function validateMagicByte(
  ...
  if (
    ...
    if (allowedTypes.includes("image/png") || allowedTypes.includes("image/*"))
      return "image/png";
  }
  // JPEG: FF D8 FF
  if (head[0] === 0xff && head[1] === 0xd8 && head[2] === 0xff) {
    if (allowedTypes.includes("image/jpeg") || allowedTypes.includes("image/*"))
      return "image/jpeg";
  }
  // GIF: 47 49 46 38
  if (
    ...
    if (allowedTypes.includes("image/gif") || allowedTypes.includes("image/*"))
      return "image/gif";
  }
  // PDF: 25 50 44 46
  if (
